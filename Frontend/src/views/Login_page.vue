                ...
                <div style="display: table;">
                    <div class="index_text">
                        ...
                        <span style="font-size: 2vh;">
                            부대간편업무 앱에 오신걸 환영합니다.
                            <br />저희 앱은 인원추적관리, 결식자 식별같은 병영생활에 도움되는 기능을 제공합니다.
                        </span>
                    </div>
                    <v-alert
                    ...
                    <v-card>
                        <v-list-item>
                            <v-form class="md-3">
                                ...
                                <v-text-field label="아이디" hide-details="auto" outlined clearable></v-text-field>
                                <br />
                                <!--속임수 -->
                                <v-text-field label="비밀번호" outlined clearable></v-text-field>
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field label="특기*" hint="예) 전포, 통신, 취사"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field
                                                label="생년월일*"
                                ...
                                <small>*진급을 하신경우 시스템에서는 반영이 안되기 때문에 수동으로 수정해줘야 합니다.</small>
                            </v-card-text>
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue darken-1" text @click="dialog = false">취소</v-btn>
                                <!--먼저 확인을 하고 저장을 한다 아닐씨 오류메세지를 표출한다.-->
                                <v-btn color="blue darken-1">저장하기</v-btn>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
                </div>
